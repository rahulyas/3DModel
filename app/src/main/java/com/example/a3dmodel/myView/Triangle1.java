...
/*import static com.example.a3dmodel.myView.firstActivity3D.list1;
import static com.example.a3dmodel.myView.firstActivity3D.triangleList;*/

import static com.example.a3dmodel.myView.NewActivity.list1;
import static com.example.a3dmodel.myView.NewActivity.triangleList;
...
/*        if (!triangleFlag){
        ...
        Log.d(TAG, "initVertexData: vertices.length ="+ Arrays.toString(vertices));
